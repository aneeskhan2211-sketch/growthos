...
function PlatformIcon({ platform }: { platform: Conversation["platform"] }) {
...
function ConversationList({
  ...
  return (
    <div className="flex flex-col h-full" data-ocid="inbox.page">
      {/* Header */}
      <div className="px-4 pt-5 pb-3 bg-card border-b border-border/50">
        ...
        {/* Search */}
        <div className="relative" data-ocid="inbox.search_input">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Your leads' replies will appear here
              </p>
            </div>
            <button
              type="button"
...
function ConversationRow({
  ...
  const initials = conv.businessName
    .split(" ")
    .slice(0, 2)
    .map((w) => w[0])
    .join("");
    ...
    >
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-muted-foreground">
                ...
                <span>⚠️ {conv.issue}</span>
                <span>💬 {conv.prevInteractions} interactions</span>
              </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
        ...
        {showSuccess && (
          ...
          >
            <span className="text-[10px] text-green-400 bg-green-500/10 px-3 py-1 rounded-full">
              ✓ Message sent
            </span>
          </motion.div>
        )}
      ...
      <div className="px-3 pb-2" data-ocid="inbox.suggestions_bar">
      ...
      {/* Input Area */}
      <div className="px-3 pb-4 pt-1 flex items-end gap-2 bg-card border-t border-border/30">
        <textarea
          ref={inputRef}
          value={inputText}
        ...
        >
          <SendIcon active={!!inputText.trim()} />
        </motion.button>
      </div>
    </motion.div>
  );
      ...
      >
        <div
          className={[
            ...
            isUser
              ? "bg-primary text-primary-foreground rounded-tr-sm rounded-l-2xl rounded-br-2xl"
              : "bg-card border border-border/40 text-foreground rounded-tl-sm rounded-r-2xl rounded-bl-2xl",
          ].join(" ")}
        >
          {msg.text}
        </div>
        ...
        >
          ...
          {isUser && (
            <span className="text-muted-foreground">
              ...
              {msg.status === "read" && <CheckIcon double blue />}
            </span>
          )}
        </div>
      </div>
